...
result1 = Label(root, text="Choose a Base",bg='#B0C4DE',fg='black',font=("Georgia",18,"bold","underline"))
result1.place(x=220,y=10)

 
result2 = Label(root, text="Enter a Number",bg='#B0C4DE',fg='black',font=("Georgia",18,"bold","underline"))
...
base = StringVar()
Radiobutton(root, text="Binary",font=15,variable=base, value="Binary",fg='#800000',bg='#B0C4DE', command=calcStyle).place(x=245,y=40)
Radiobutton(root, text="Decimal",font=15,variable=base, value="Decimal",fg='#800000',bg='#B0C4DE', command=calcStyle).place(x=245,y=65)
Radiobutton(root, text="Hexadecimal",font=15,variable=base, value="Hexadecimal",fg='#800000',bg='#B0C4DE', command=calcStyle).place(x=245,y=90)
Radiobutton(root, text="Octal",font=15,variable=base, value="Octal",fg='#800000',bg='#B0C4DE', command=calcStyle).place(x=245,y=115)
